	...
	echo '<div class="adm_table">';
			...
			if(isset($basic))
			{
				if($basic->num_rows() > 0)
				{
					...
					echo '<table id="adm_table">';
						echo "<tr><td colspan=\"42\">Full Names &nbsp&nbsp&nbsp&nbsp <a href=\"".base_url()."admissions/update/basic\">Edit</a></td></tr>";
			...
			if(isset($personal))
			{
				if($personal->num_rows() > 0)
				{
					...
					echo '<table id="adm_table">';
						echo "<tr><td colspan=\"42\"> Personal Details &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href=\"".base_url()."admissions/update/personal\"> Edit </a></td></tr>";
			...
			if(isset($contacts))
			{
				if($contacts->num_rows() > 0)
				{
					...
					echo '<table id="adm_table">';
						echo "<tr><td colspan=\"42\"> Contact Details &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href=\"".base_url()."admissions/update/contacts\"> Edit </a></td></tr>";
			...
			if(isset($father_details))
			{
				if($father_details->num_rows() > 0)
				{
					...
					echo '<table id="adm_table">';
						echo "<tr><td colspan=\"42\"> Father's Details &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href=\"".base_url()."admissions/update/fdetails\"> Edit </a></td></tr>";
						echo "<tr><td>First Name: </td><td>{$f_name}</td></tr>";
						echo "<tr><td>Last Name: </td><td>{$l_name}</td></tr>";
						echo "<tr><td>Postal Address: </td><td>{$paddress}</td></tr>";
						echo "<tr><td>Postal Code: </td><td>{$pcode}</td></tr>";
			...
			if(isset($mother_details))
			{
				if($mother_details->num_rows() > 0)
				{
					...
					echo '<table id="adm_table">';
						echo "<tr><td colspan=\"42\"> Mother's Details &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href=\"".base_url()."admissions/update/mdetails\"> Edit </a></td></tr>";
						echo "<tr><td>First Name: </td><td>{$f_name}</td></tr>";
						echo "<tr><td>Last Name: </td><td>{$l_name}</td></tr>";
						echo "<tr><td>Postal Address: </td><td>{$paddress}</td></tr>";
						echo "<tr><td>Postal Code: </td><td>{$pcode}</td></tr>";
			...
			if(isset($guardian_details))
			{
				if($guardian_details->num_rows() > 0)
				{
					...
					echo '<table id="adm_table">';
						echo "<tr><td colspan=\"42\"> Guardian's Details &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href=\"".base_url()."admissions/update/gdetails\"> Edit </a></td></tr>";
						echo "<tr><td>First Name: </td><td>{$f_name}</td></tr>";
						echo "<tr><td>Last Name: </td><td>{$l_name}</td></tr>";
						echo "<tr><td>Postal Address: </td><td>{$paddress}</td></tr>";
						echo "<tr><td>Postal Code: </td><td>{$pcode}</td></tr>";
