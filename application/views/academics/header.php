    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="background : rgba(255,255,255,0.3); ">
                    <!--<li class="active" style="background : rgba(255,255,255,0.1); "><a href="<?php echo base_url(); ?>home"><i class="fa fa-fw fa-dashboard"></i> Dashboard</a></li>-->
					...
					<li class="active"><a href="javascript: ;" data-toggle="collapse" data-target="#academics_options"><i class="fa fa-fw fa-file"></i> Examinations</a>
						...
						?>
							...
							<!--<li><a href="<?php //echo base_url(); ?>academics/classlists">Get Class List</a></li>-->
						<?php
						}
						else
						{
						?>
							...
							<li><a href="<?php echo base_url(); ?>academics/spreadsheets">Spreadsheets</a></li>
							<li><a href="<?php echo base_url(); ?>academics/reports">Reports</a></li>
							<!--<li><a href="<?php //echo base_url(); ?>academics/class_list">Get Class List</a></li>-->
